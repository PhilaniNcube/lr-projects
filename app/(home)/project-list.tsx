						...
						{projects.map((project) => (
							<div key={project.title} className="relative group">
								<img
									src={project.image}
									alt={project.title}
									className="object-cover w-full rounded-lg shadow-lg aspect-[3/6] sm:aspect-[3/4] md:aspect-[3/5] lg:aspect-[3/4] xl:aspect-[3/4]"
								/>
								<div className="absolute inset-0 flex flex-col justify-end p-8 text-white rounded-lg group-hover:bg-slate-950/30 bg-slate-950/60">
									...
									<Button
										type="button"
										className="mt-3 bg-emerald-950 gap-x-2"
									>
										<Link
